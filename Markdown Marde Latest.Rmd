...
neonicyear <- ggplot(honey, aes(x = year, y = nAllNeonic)) + geom_col() + facet_grid(.~ Region)
```
...
Interestingly, the Midwest remains the highest producer of Neonics followed by the south. Why the midwest still remains the highest producer of honey could be explained by biological and geographical factors which are beyond the scope of the study.  
