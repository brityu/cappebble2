...
Figure1 <- ggplot(data = byproduction, mapping = aes(x = log(nAllNeonic), 
  ...
  labs (x = "log of Total Neonic (kg)", 
        ...
        title = " Bee Honey Production under Neonic Pesticide by Region"); Figure1
```
...
clomid.cor <- cor.test(midwest$totalprod, midwest$Clothianidin, 
                       method = "spearman", exact = FALSE)
midmid.cor <- cor.test(midwest$totalprod, midwest$Imidacloprid, 
                       method = "spearman", exact = FALSE)
...
clone.cor <- cor.test(northeast$totalprod, northeast$Clothianidin, 
                      method = "spearman", exact = FALSE)
midne.cor <- cor.test(northeast$totalprod, northeast$Imidacloprid, 
                      method = "spearman", exact = FALSE)
...
closouth.cor <- cor.test(south$totalprod, south$Clothianidin, 
                         method = "spearman", exact = FALSE)
midsouth.cor <- cor.test(south$totalprod, south$Imidacloprid, 
                         method = "spearman", exact = FALSE)
...
clowest.cor <- cor.test(west$totalprod, west$Clothianidin, 
                        method = "spearman", exact = FALSE)
midwest.cor <- cor.test(west$totalprod, west$Imidacloprid, 
                        method = "spearman", exact = FALSE)
...
Region. <- c("Midwest", "Midwest", "Midwest", "Midwest", "Midwest", 
             ...
             "West", "West","West")
NeonicType <- c("Acetamiprid", "Clothianidin", "Imidacloprid", "Thiamethoxam", 
                "Thiacloprid", "Acetamiprid", "Clothianidin", "Imidacloprid", 
                "Thiamethoxam", "Thiacloprid", "Acetamiprid", "Clothianidin", 
                "Imidacloprid", "Thiamethoxam", "Thiacloprid", "Acetamiprid", 
                "Clothianidin", "Imidacloprid", "Thiamethoxam", "Thiacloprid")
